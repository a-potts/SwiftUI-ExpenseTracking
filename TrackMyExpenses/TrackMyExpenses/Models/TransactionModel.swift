...
extension Category {
    ...
    static let income = Category(id: 7, name:
    ...
    static let homeSupplies = Category(id: 602, name: "Home Supplies",
    icon: .lightbulb, mainCategoryId: 6)
    static let paycheque = Category(id: 701, name: "Paycheque", icon:.icons, mainCategoryId: 8)
    static let software = Category(id: 801, name:"Software",icon: .dollar_sign, mainCategoryId: 7)
